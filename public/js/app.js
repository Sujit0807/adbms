...
function updateCart(decoration) {
  // asynchronous call using axios
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', decoration).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var decoration = JSON.parse(btn.dataset.decoration);
    updateCart(decoration);
  });
...
updateStatus(order);
Object(_stripe__WEBPACK_IMPORTED_MODULE_4__["initStripe"])(); // Socket client side

var socket = io(); // Join 

if (order) {
  socket.emit('join', "order_".concat(order._id));
} // Realtime admin page updating
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_3__["loadStripe"])('pk_test_51K053qSAsAg6Jebt3XCE6g9HdJBn3kb7PbOD5GUxxEImuGsgjQb0oMnVgdML8yOngGyKNMOjRIwCVb8666kL3kHt00QEKF2qMj');
          ...
          case 8:
            ...
            if (paymentForm) {
              paymentForm.addEventListener('submit', function (e) {
                ...
                axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/orders', formObject).then(function (res) {
...
__webpack_require__(/*! C:\Users\DELL\Desktop\Subjects\Adbms\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\DELL\Desktop\Subjects\Adbms\resources\scss\app.scss */"./resources/scss/app.scss");
